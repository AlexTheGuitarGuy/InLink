    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="mt-20 flex justify-center flex-wrap">
        <div>
          ...
          <div>
            <button className="text-gray-900 text-center bg-gray-300 border border-gray-400 rounded relative w-full">
              Log in
            </button>
          </div>
        ...
        <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
          ...
          <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
            <form>
              ...
              <a
                className="bg-sky-400 px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center"
                href="#!"
                role="button"
                data-mdb-ripple="true"
                data-mdb-ripple-color="light"
