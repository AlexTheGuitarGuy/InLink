...
describe('Paginator component', () => {
  test('selected page has separate style', () => {
    ...
    expect(() =>
      component.findByProps({ className: 'chosenPage' }),
    ).not.toThrow();
  });
  ...
  test('portion size is consistent and described in parameters', () => {
    ...
    expect(() =>
      component.findByProps({ portionSize: 10 }),
    ).not.toThrow();
  });
  ...
  test('selected page is at beginning of portion if it is first', () => {
    ...
    expect(component.children[0].children[0].props.className).toBe(
      'chosenPage',
    );
  });
  ...
  test(`selected page doesn't get in the middle until it passes halfway point in portion`, () => {
    ...
    expect(component.children[0].children[6].props.className).toBe(
      'chosenPage',
    );
  });
  ...
  test(`selected page is in the middle when it isn't close to the extremes`, () => {
    ...
    expect(component.children[0].children[7].props.className).toBe(
      'chosenPage',
    );
  });
  ...
  test('selected page is at the end of portion if it is last', () => {
    ...
    expect(component.children[0].children[11].props.className).toBe(
      'chosenPage',
    );
  });
});
