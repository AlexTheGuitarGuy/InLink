...
const dialogsReducer = (
  ...
  action: sendMessageActionType | deleteMessageActionType | editMessageActionTpe,
) => {
  switch (action.type) {
    case SEND_MESSAGE:
      if (action.text) {
...
export const editMessage = (userId: number, messageId: number, text: string) => ({
  type: EDIT_MESSAGE,
  userId,
  messageId,
  text,
